...
public final class ItemHomeBinding implements ViewBinding {
  ...
  private ItemHomeBinding(@NonNull ConstraintLayout rootView, @NonNull AppCompatImageView ivImage,
  ...
  public static ItemHomeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemHomeBinding((ConstraintLayout) rootView, ivImage, parent);
    }
