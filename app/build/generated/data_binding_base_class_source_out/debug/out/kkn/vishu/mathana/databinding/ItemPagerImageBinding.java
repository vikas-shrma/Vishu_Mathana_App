...
public final class ItemPagerImageBinding implements ViewBinding {
  ...
  private ItemPagerImageBinding(@NonNull ConstraintLayout rootView,
  ...
  public static ItemPagerImageBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.item_pager_image, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ItemPagerImageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemPagerImageBinding((ConstraintLayout) rootView, animationView, ivImage);
    }
